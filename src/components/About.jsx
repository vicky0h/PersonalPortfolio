...
const About = () => {
  return (
    <>
      ...
      >
       Results-driven full stack web developer with an accounting background, skilled in React and Node.js. As a quick learner, efficient performer, and strong team player, I am seeking an entry-level opportunity in a front-end, back-end, or full-stack role to contribute technical expertise and deliver innovative solutions. Let's bring your ideas to life!
      </motion.p>

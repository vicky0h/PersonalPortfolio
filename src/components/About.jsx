...
const About = () => {
  return (
    <>
      ...
      >
        I am a full stack developer with a finance / accounting background,
        seeking an entry-level opportunity in utilizing React, Node.js for
        a full-stack, front-end, or back-end role. I am a quick leaner, efficient
        performer, and good team player. Let's work together to bring your ideas
        to life!
      </motion.p>
